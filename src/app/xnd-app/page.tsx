...
export default function XndApp() {
    return (
        ...
        >
            <section
                className='relative -z-30 container-padding-x bg-black pt-12 landing-page-hero-image w-full'
            ...
            >
                ...
                <div aria-describedby='CTA' className='w-full flex flex-col items-center gap-8'>
                    ...
                    <Link
                        href="/login"
                        className="py-2 px-4 w-fit lg:w-40 bg-[#FBBD08] lg:w-32 h-10 text-center hover:opacity-20 rounded-3xl"
                    >
                        Get started
                    </Link>
